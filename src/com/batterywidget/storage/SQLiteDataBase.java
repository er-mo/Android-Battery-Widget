...
public class SQLiteDataBase {
	...
	private static class DataBaseOpenHelper extends SQLiteOpenHelper {
		...
		private static final String DB_SQL_CREATE = "CREATE TABLE " + Constants.DB_TABLE + " (" +
				Constants.KEY_ID + " integer PRIMARY KEY AUTOINCREMENT, " +
				Constants.KEY_TIME + " LONG NOT NULL, " +
				Constants.KEY_LEVEL + " INT NOT NULL);";
	...
	public Cursor getEntries() {
		return sqLiteDataBase.query(
				Constants.DB_TABLE,
				new String[] { Constants.KEY_ID, Constants.KEY_TIME, Constants.KEY_LEVEL },
				Constants.KEY_TIME +" > "+ (new Date().getTime() - 1000 * 60 * 60 * 24 * 7), null, null, null, null);	
	}
